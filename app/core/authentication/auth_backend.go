...
import (
	...
	"github.com/serafimone/InformationTagger/app/core/redis"
...
func getPrivateKey() *rsa.PrivateKey {
	privateKeyFile, err := os.Open(config.GetConfig().PrivateKeyPath)
	if err != nil {
		panic(err)
	}
...
func getPublicKey() *rsa.PublicKey {
	publicKeyFile, err := os.Open(config.GetConfig().PublicKeyPath)
	if err != nil {
		panic(err)
	}
